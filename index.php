...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>UW Madison 2020 Climate Change Hackathon</title>
		...
		************************************** -->
		<div id="body-content">
			...
			<section id="tt-intro" class="image-intro">
				<div class="tt-intro-inner full-height-vh tt-wrap bg-image" style="background-image: url(assets/img/intro/intro-5.jpg); background-position: 50% 50%;"> <!-- add/remove class "tt-wrap" to enable/disable element boxed layout (class "tt-boxed" is required in <body> tag! ) -->
					<!-- Element cover -->
					...
					* Size classes: "intro-caption-xs", "intro-caption-sm", "intro-caption-lg", "intro-caption-xlg", "intro-caption-xxlg".
					...
					<div class="intro-caption caption-animate intro-caption-xxlg center-left">
									...
									<h2 class="intro-subtitle">2020 Climate Change Hackathon!</h2>
									<br>
									<h3>Join us at the UW-Madison Education Building</h3>
									<h3>August 9th to 10th, 2020</h3>
						<div class="margin-top-30">
							<a href="https://themeforest.net/item/sepia-photography-portfolio-html-website-template/20195226?ref=Themetorium" class="btn btn-primary margin-top-5 margin-right-10" target="_blank">Register Now!</a>
						</div>
					</div>
					<!-- End intro caption -->
											...
											* Use classes "tt-heading-xs", "tt-heading-sm", "tt-heading-lg", "tt-heading-xlg" or "tt-heading-xxlg" to set tt-heading size.
											...
											<div class="tt-heading">
												<div class="tt-heading-inner">
													...
													<div class="tt-heading-subtitle">Who we are and what we do</div>
													<hr class="hr-short">
											...
											<div class="margin-top-30">
												<p>Hi, we are <strong>Hack 500</strong>. We work with UW Madison to make coding accessible to people throughout Wisconsin and to celebrate the creativity and diversity of viewpoints each participant brings. Through our annual hackathons, we hope to bring in those who might otherwise shy away from STEM.</p>
											</div>

											<a href="eventGoal.php" class="btn btn-primary margin-top-20">2020 Goals</a>
											<a href="contact.html" class="btn btn-dark margin-top-20">Contact Us!</a>
